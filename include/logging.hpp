...
void Log(std::string in_format_str, Args&&... in_args)
{
    ...
    {
        if constexpr (log_level == LogLevel::kDebug) return "[\033[37mDebug\033[0m]: ";
        ...
        else if constexpr (log_level == LogLevel::kError) return "[\033[31mError\033[0m]: ";
        else if constexpr (log_level == LogLevel::kCritical) return "[\033[31mCritical\033[0m]: ";
